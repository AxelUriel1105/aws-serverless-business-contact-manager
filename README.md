...
Locate the configuration constants at the beginning of the <script> tag.

Update the values with your unique deployment outputs:
...
Developed as a high-performance cloud architecture showcase.
